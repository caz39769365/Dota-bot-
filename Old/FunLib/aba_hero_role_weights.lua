local HeroRoleMap = {
    ...
    ['npc_dota_hero_bounty_hunter'] = {0, 5, 10, 50, 35},-- Positions 4,5, occasional offlane
    ['npc_dota_hero_brewmaster'] = {5, 5, 85, 5, 0},     -- Positions 3, occasional mid
    ['npc_dota_hero_bristleback'] = {30, 30, 30, 10, 0}, -- Versatile core roles
    ...
    ['npc_dota_hero_dark_willow'] = {0, 5, 10, 40, 25},  -- Positions 4,5
    ['npc_dota_hero_dawnbreaker'] = {5, 10, 75, 10, 0},  -- Positions 3,2
    ['npc_dota_hero_dazzle'] = {0, 5, 10, 30, 55},       -- Positions 5,4
    ...
    ['npc_dota_hero_elder_titan'] = {0, 5, 10, 50, 15},  -- Positions 4,5
    ...
    ['npc_dota_hero_hoodwink'] = {0, 5, 10, 50, 15},     -- Positions 4,5
    ...
    ['npc_dota_hero_lone_druid'] = {50, 35, 15, 0, 0},    -- Positions 1,2
    ['npc_dota_hero_luna'] = {70, 5, 15, 0, 0},           -- Positions 1, occasional mid
    ['npc_dota_hero_lycan'] = {45, 5, 45, 5, 0},          -- Positions 3, occasional mid
    ['npc_dota_hero_magnataur'] = {5, 5, 85, 5, 0},      -- Positions 3, occasional mid
    ['npc_dota_hero_marci'] = {0, 5, 30, 30, 15},        -- Positions 4,5
    ['npc_dota_hero_mars'] = {5, 5, 85, 5, 0},           -- Positions 3, occasional mid
    ['npc_dota_hero_medusa'] = {50, 45, 5, 0, 0},         -- Positions 1, occasional mid
    ['npc_dota_hero_meepo'] = {25, 70, 5, 0, 0},          -- Positions 2,1
    ['npc_dota_hero_mirana'] = {0, 5, 10, 65, 20},       -- Positions 4,5
    ['npc_dota_hero_morphling'] = {80, 15, 5, 0, 0},      -- Positions 1, occasional mid
    ['npc_dota_hero_monkey_king'] = {50, 25, 25, 0, 0},   -- Positions 1,2
    ['npc_dota_hero_naga_siren'] = {70, 5, 5, 0, 0},     -- Positions 1, occasional mid
    ['npc_dota_hero_necrolyte'] = {15, 55, 25, 5, 0},      -- Positions 2,3
    ...
    ['npc_dota_hero_ogre_magi'] = {0, 15, 10, 30, 45},    -- Positions 5,4
    ...
    ['npc_dota_hero_primal_beast'] = {5, 5, 45, 5, 0},   -- Positions 3, occasional mid
    ...
    ['npc_dota_hero_storm_spirit'] = {25, 50, 5, 0, 0},   -- Positions 2, occasional carry
    ...
    ['npc_dota_hero_viper'] = {25, 45, 25, 5, 0},          -- Positions 2,3
    ...
    ['npc_dota_hero_warlock'] = {0, 5, 10, 30, 55},      -- Positions 5,4
    ...
    ['npc_dota_hero_wisp'] = {0, 5, 10, 35, 30},         -- Positions 4,5
